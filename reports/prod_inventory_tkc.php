...
$sql="select tbl_2.*,prod.*,bcode.barcode,bcode.price,bcode.cost,bcode.unit,tbl_2.item_desc from (select skuid,sum(in_total) in_total,sum(out_total) out_total,sum(in_total-out_total) bal_total,item_desc from (
