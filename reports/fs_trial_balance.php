...
<div class="print" style="width:900px;font-family:FontA11, Arial, Verdana, Geneva, Arial, Helvetica, Sans-Serif;">
	...
	<table id="mytbl" class="tbl" cellspacing="0" cellpadding="0" width="100%">
		...
		<tbody>
			...
			// echo "</pre>";
			// exit;
			usort($newlist, $db->make_cmp(['account_group' => "asc",'account_desc' => "desc"]));
			...
			?>
				<tr>
					...
					<td><?='<a href="./ledger_summary.php?where='.$_REQUEST['where'].' and `account_code`=\''.$row['account_code'].'\'" target="_blank">['.$row['account_code'].']</a> '.$row['account_desc'].' ('.$row['num'].')'?></td>
