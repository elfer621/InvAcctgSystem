		...
		<? 	while($row = mysql_fetch_assoc($qry)){ 
				...
				?>
					<tr>
						...
						<td style="text-align:center;"><?= $db->outputInvBal($ucmain,$row['sku_id']); ?></td>
						<td style="text-align:center;"><?= $db->outputInvBal($uclm,$row['sku_id']); ?></td>
						<td style="text-align:center;"><?= $db->outputInvBal($ucmambaling,$row['sku_id']); ?></td>
						<td style="text-align:center;"><?= $db->outputInvBal($ucbanilad,$row['sku_id']); ?></td>
						<td style="text-align:center;"><?= $db->outputInvBal($warehouse,$row['sku_id']); ?></td>
