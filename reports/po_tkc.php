...
<div class="logo">
	...
	<span style="font-size:17px;">PURCHASE ORDER</span>
</div>
<div style="float:left;width:45%;">
	...
	<div style="clear:both;height:5px;"></div>
	<div class="lbl">Address:</div><div style="float:left;width:75%;"><?//=$info['contact_person']?></div>
	<div style="clear:both;height:5px;"></div>
</div>
<div style="float:right;width:45%;">
	...
	<div style="float:left;">Date:&nbsp;&nbsp;<?php echo $info['date'] ?></div>
	<!--div style="clear:both;height:5px;"></div>
...
<table class="tbl" cellspacing="0" cellpadding="0" width="100%">
	...
	while($row_items = mysql_fetch_assoc($sql_item)){
		...
		echo "<td>".$row_items['unit']."</td>";
		echo "<td style='text-align:right;'>{$row_items['item_desc']}</td>";
	...
	<tfoot>
		...
		<tr>
			<td colspan='4' style="text-align:right;">Less Volume Discount:</td>
		...
		<tr>
			<td colspan='4' style="text-align:right;">Additional Discount:</td>
