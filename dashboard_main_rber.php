...
<input id="bt6" class="buthov" type="button" onclick="window.location='?page=quotation';" value="Quotation" style="height:40px;width:100%;float:left;"/>
<br/>
<hr/>
...
<br/>
<input id="bt3" class="buthov" type="button" onclick="window.location='?page=dynamic_invoicing&tbltype=tra';" value="TRA" style="height:40px;width:100%;float:left;"/>
<br/>
