...
if($_POST['save_itemprod']){
	...
	$insert_prod="insert into tbl_product_name (sku_id,product_name,base_unit,supplier_id,category_id,manufacturer_id,
			school_level,subject_name,subjtype,tax_type,hidden,imageData) values 
			...
			subject_name=values(subject_name),subjtype=values(subjtype),tax_type=values(tax_type),imageData=values(imageData)";
