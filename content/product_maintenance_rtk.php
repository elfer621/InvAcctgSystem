...
if($_POST['save_itemprod']){
	...
	$insert_prod="insert into tbl_product_name (sku_id,product_name,base_unit,supplier_id,category_id,manufacturer_id,
			...
			subject_name=values(subject_name),subjtype=values(subjtype),tax_type=values(tax_type),lotno=values(lotno),expdate=values(expdate)";
...
// echo "</pre>";
?>
<div style="height:400px;overflow:auto;background-color:white;">
					...
					<div style="float:left;">
						...
						<div style="float:left;margin-right:20px;">
							...
							<div id="subinfo">
								...
								<div style="clear:both;height:5px;"></div>
								<div style="clear:both;height:5px;"></div>
								<div style="float:left;margin-right:10px;width:100px;">Selling</div>
						...
						<div style="float:left;">
							...
							<div style="clear:both;height:5px;"></div>
							<div style="float:left;margin-right:10px;width:100px;">Lot No.</div>
							<input type="text" name="lotno" id="lotno" value="<?=$info?$info['lotno']:""?>" />
							<div style="clear:both;height:5px;"></div>
							<div style="float:left;margin-right:10px;width:100px;">Exp Date.</div>
							<input type="text" name="expdate" id="expdate" value="<?=$info?$info['expdate']:""?>" />
							<div style="clear:both;height:5px;"></div>
						</div>
					</div>
					<?php /*
