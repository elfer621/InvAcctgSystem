...
<div class="content" style="min-height:300px;width:900px;margin:0 auto;">
	...
	<h2 style="text-align:center;">Physical Examination</h2>
		...
		<div style="width:100%;float:right;">
			<div style="display: flex;">
				<fieldset style="align-items: stretch;width:100%;float:left;">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									...
									BMI:<input value="<?=$info['bmi']?>" type="text" name="info[bmi]"/>
								</td>
							</tr>
							<tr>
								<td>Blood Pressure</td>
								<td>
									<?=$rec['blood_pressure']['systolic']."/".$rec['blood_pressure']['diastolic']." mmHg"?>
									<span style="float:right;width:250px;">Classification: <?=$info['bp']?></span>
								</td>
							</tr>
							<tr>
								<td>Pulse Rate:</td>
								<td><?=$rec['pulse_rate']?> bpm</td>
							</tr>
							<tr>
								<td>Respiratory Rate:</td>
								<td><?=$rec['respiratory_rate']?> cpm</td>
							</tr>
							<tr>
								<td>Temperature:</td>
								<td><?=$rec['temperature']?> <sup>o</sup>c</td>
							</tr>
							<tr>
								<td>Smoker:</td>
								<td>
					...
					<fieldset>
					<legend>-</legend>
					<table class="navigateableMain" id="items_tbl" cellspacing="0" cellpadding="0" width="45%" style="float:left;">
						<thead>
							<tr>
								<td></td>
								<td>Normal</td>
			...
			<div style="width:400px;text-align:center;float:right;">
				...
				<div style="font-size:10px;width:50%;margin:0 auto;">PHYSICIAN<br/>LIC#__________________ PTR#__________________</div>
			</div>
		</div>
		<div style="clear:both;height:20px;"></div>
	</form>
