	...
	<div style="clear:both;height:10px;"></div>
		...
		<div style="width:83%;float:right;">
			<fieldset style="float:left;width:95%;">
				...
				<input id="bt9" class="buthov" type="button" value="Daily Sales" style="float:right;height:40px;width:150px;float:left;" onclick="viewReport('reports/sales_invoice_dailysummary.php');"/>
			</fieldset>
			<div style="clear:both;height:5px;"></div>
