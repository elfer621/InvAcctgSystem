	...
	<div style="clear:both;height:10px;"></div>
		<div style="width:25%;float:left;">
			<fieldset>
				...
				<input value="<?=$info['customer_address']?>" type="text" style="width:100%;"/>
				<div style="clear:both;height:5px;"></div>
				<div style="width:150px;float:left;">Telephone Number</div>
				<input value="<?=$info['contact_number']?>" type="text" style="width:100%;"/>
				<div style="clear:both;height:5px;"></div>
				<div style="width:150px;float:left;">Fax Number</div>
				<input value="<?=$info['fax_person']?>" type="text" style="width:100%;"/>
				<div style="clear:both;height:5px;"></div>
				<div style="width:150px;float:left;">Contact Person</div>
				<input value="<?=$header['attn']?$header['attn']:$info['contact_person']?>" type="text" name="info[attn]" style="width:100%;"/>
				<div style="clear:both;height:5px;"></div>
				<div style="width:150px;float:left;">TIN</div>
				<input value="<?=$info['tin']?>" type="text" style="width:100%;"/>
				<div style="clear:both;height:5px;"></div>
			</fieldset>
			<fieldset>
				<legend>Details</legend>
					<div style="width:150px;float:left;">Ref ID</div>
					<input type="text" name="refid" value="<?=$header['id']?>" style="width:100%;"/>
					<div style="clear:both;height:5px;"></div>
					...
					<input value="<?=$header['region']?>" type="text" name="info[region]" style="width:100%;"/>
					<div style="clear:both;height:5px;"></div>
					<div style="width:150px;float:left;">REP:</div>
					<select name="info[rep]" style="width:100%;">
						<option value="">Select</option>
						<?php
