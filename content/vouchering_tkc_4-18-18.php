		...
		<div class="content" style="min-height:300px;">
			<div style="float:left;width:170px;text-align:center;">
				...
				<fieldset style="padding:5px;text-align:center;">
					...
					<input id="bt9" class="buthov" type="button" value="Print" onclick="viewReport('./reports/vouchering<?=$_SESSION['repExtension']?>.php?refid=<?=$info['id'] ?>&center=<?=$info['center']?>&type=<?=$info['type']?>');" style="height:40px;width:150px;"/>
...
$("input[name='dr_amt[]'], input[name='cr_amt[]'], input[name='amt[]']").live('change',function(){
...
function ChartOfAccount(){
 ...
 $('input[type=radio][name=supporting_type]').change(function() {
	switch(this.value){
		default:
