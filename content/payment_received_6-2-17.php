...
if($_POST){
	...
	$receipt="insert into tbl_receipt_manual (`receipt`,`date`,`cust_id`,`receivedfrom`,`paymentof`,
		`cash_amt`,`check_amt`,`check_details`,`check_date`,`particular`,rent_amount,other_amount,total_amount,bp_date,bp_bank,bp_amt) values 
		('{$_REQUEST['ornum']}','".$_REQUEST['ordate']."','{$_REQUEST['CRJ']['customer_name']}','{$_REQUEST['CRJ']['receivedfrom']}','{$_REQUEST['CRJ']['paymentof']}',
		...
		'{$_REQUEST['CRJ']['bp_date']}','{$_REQUEST['CRJ']['bp_bank']}','{$_REQUEST['CRJ']['bp_amt']}')";
